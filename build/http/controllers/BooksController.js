...
class BooksController {
    get(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const builder = data_source_1.AppDataSource.getRepository(Book_1.Book)
            ...
            return Response_1.ResponseUtil.sendResponse(res, 'Fatched books successfully', bookData, paginationInfo);
        });
    }
    getBook(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            book.image = ImageUtil_1.ImageUtil.prepareUrl('books', book.image);
            return Response_1.ResponseUtil.sendResponse(res, 'Fatch books successfully', book.toPayload());
        });
    }
    create(req, res) {
        var _a;
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield repo.save(book);
            return Response_1.ResponseUtil.sendResponse(res, 'Susseccfully updates the book', book.toPayload());
        });
    }
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
